...
export const ordersData = [
  ...
  },
  {
    ...
    TotalAmount: 56.34,
    Task: 'Tours and Travels Website',
    Location: 'Delhi',
    Status: 'complete',
    StatusBg: '#8BE78B', 
},
...
export const PyramidData = [
  { x: 'CRM,Website', y: 120, text: '90%' },
  { x: 'Poster,Digital Marketing', y: 145, text: '97%' },
  { x: 'IV package', y: 470, text: '60%' },
];
